  ...
  return (
    <View style={styles.container}>
      <View style={styles.row}>
        <Pressable style={styles.pressable} onPress={() => onPress('Gryffindor')}>
          <Text style={styles.text}>Gryffindor</Text>
        </Pressable>
        <Pressable style={styles.pressable} onPress={() => onPress('Slytherin')}>
          <Text style={styles.text}>Slytherin</Text>
        </Pressable>
      </View>
      <View style={styles.row}>
        <Pressable style={styles.pressable} onPress={() => onPress('Ravenclaw')}>
          <Text style={styles.text}>Ravenclaw</Text>
        </Pressable>
        <Pressable style={styles.pressable} onPress={() => onPress('Hufflepuff')}>
